...
# -*- coding: utf-8 -*-
#
# STARE documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = 'FuFis'
copyright = 'Hecker2024'
author = 'Dennis Hecker'
...
latex_documents = [
    # (master_doc, 'STARE.tex', 'STARE Supplemental Material',
    #  'Dennis Hecker', 'manual'),
]
...
man_pages = [
    (master_doc, 'FuFi', 'FuFi Documentation',
     [author], 1)
]
